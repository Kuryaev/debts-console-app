...
abstract class _$ReportItemModelCWProxy {
  ...
  ReportItemModel debts(List<ReportDebtModel> debts);
...
class _$ReportItemModelCWProxyImpl implements _$ReportItemModelCWProxy {
  ...
  @override
  ReportItemModel debts(List<ReportDebtModel> debts) => this(debts: debts);
  ...
  ReportItemModel call({
    ...
    return ReportItemModel(
      ...
      paid: paid == const $CopyWithPlaceholder() || paid == null
          ...
          // ignore: cast_nullable_to_non_nullable
          : paid as double,
      debts: debts == const $CopyWithPlaceholder() || debts == null
          ? _value.debts
          // ignore: cast_nullable_to_non_nullable
          : debts as List<ReportDebtModel>,
